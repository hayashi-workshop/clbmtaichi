...
length = 30. 
width  =  3.
obstacle = NestedObstacleManager(center_list=[75., 60.5, 60.5], length=length, width=width, nd=nd0)
...
save_vtk(tree, step, f"./output/nested3d_plate") # read pvd file to import multi-grids in Paraview
