...
class ModelConfig:
    ...
    def col_stream_core(self, lbm: ti.template(), f_pre: ti.template(), f_post: ti.template()):
        for i, j in ti.ndrange((ti.static(self.pop), ti.static(lbm.nd[0] - self.pop)), (ti.static(self.pop), ti.static(lbm.nd[1] - self.pop))):
            ...
            xm1 = f2 + f4
            xm2 = f5 + f8
            chimera_m_m1_c_0 = f3 + xm0
            chimera_m_m1_c_1 = f6 - f7
            chimera_m_m1_c_2 = xm0
            chimera_m_0_c_0 = f0 + xm1
            chimera_m_0_c_1 = f2 - f4
            chimera_m_0_c_2 = xm1
            chimera_m_1_c_0 = f1 + xm2
            chimera_m_1_c_1 = f5 - f8
            chimera_m_1_c_2 = xm2
            m00 = chimera_m_0_c_0 + chimera_m_1_c_0 + chimera_m_m1_c_0 + 1
            m10 = chimera_m_1_c_0 - chimera_m_m1_c_0
            m01 = chimera_m_0_c_1 + chimera_m_1_c_1 + chimera_m_m1_c_1
            ...
            dm00 = chimera_m_0_c_0 + chimera_m_1_c_0 + chimera_m_m1_c_0
            rho = m00
            inv_rho = 1.0/rho
            u = inv_rho*m10
            v = inv_rho*m01
            ...
            kappa22 = -kappa02*u**2 - 4*kappa11*u*v - 2*kappa12*u - kappa20*v**2 - 2*kappa21*v + m22 - rho*u**2*v**2
            xc0 = inv_rho
            C22 = -kappa02*kappa20*xc0 - 2*kappa11**2*xc0 + kappa22
            kappa11_post = kappa11*(1 - lbm.omega[1])
            kappa20_post = kappa20 + lbm.omega[1]*(kappa02 - kappa20) * 0.5 - lbm.omega[2]*(3*kappa02 + 3*kappa20 - 2*rho) * self.INV_6
            kappa02_post = kappa02 - lbm.omega[1]*(kappa02 - kappa20) * 0.5 - lbm.omega[2]*(3*kappa02 + 3*kappa20 - 2*rho) * self.INV_6
            kappa21_post = kappa21*(1 - lbm.omega[3])
            kappa12_post = kappa12*(1 - lbm.omega[3])
            C22_post = C22*(1 - lbm.omega[6])
